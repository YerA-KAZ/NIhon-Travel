...
const content = `export const LANGUAGE_OPTIONS = [
  { value: "en", label: "EN" },
  { value: "ru", label: "RU" },
  { value: "kk", label: "KK" },
];
...
export const places = [
  {
    ...
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Tokyo_Akihabara_district_2006.jpg/1280px-Tokyo_Akihabara_district_2006.jpg",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Ikebukuro_night.jpg/1280px-Ikebukuro_night.jpg",
  },
  {
    id: 4,
    ...
    img: "https://live.staticflickr.com/7218/7283785876_00b1d39f1e_b.jpg",
  },
  {
    id: 5,
    ...
    img: "https://www.smallworlds.jp/wp-content/uploads/2020/10/main-visual-sp.jpg",
  },
  {
    id: 6,
...
export const fansPanels = {
  ...
  weathering: {
    ...
    cards: [
      { img: "https://cdn.cheapoguides.com/wp-content/uploads/sites/2/2019/08/W2A4541-1024x600.jpg", loc: text("Shinjuku, Tokyo", "Синдзюку, Токио", "Шинджуку, Токио"), name: text("Shinjuku Streets", "Красные фонари Синдзюку", "Шинджуку көшелері"), text: text("Neon-lit alleys where Hodaka arrives.", "Неоновые переулки, куда прибывает Ходака.", "Ходака келетін неон аллеялары.") },
...
`;
fs.writeFileSync('c:/Users/toph8/OneDrive/Desktop/japan-travel (4) — копия/japan-travel/react-frontend/src/update_copy.js', content);
